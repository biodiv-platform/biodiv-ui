...
export function tooltipHelpers(tip, tooltipRenderer) {
  const mousemove = function (e) {
    tip
      .style("left", pointer(e)[0] + 10 + "px") // It is important to put the +90: other wise the tooltip is exactly where the point is an it creates a weird effect
      .style("top", pointer(e)[1] - 50 + "px");
  };
